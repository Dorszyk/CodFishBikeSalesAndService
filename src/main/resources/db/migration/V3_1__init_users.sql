...
insert into codfish_bike_user (user_id, user_name, email, password, active) VALUES (1,'piotr_korba','piotr.korba@codfishbike.com','$2a$12$qEARuAzdYKu0tEd3knZbZuxDL79iABC1cDYtbsD45/ikp0UuCueIq',true);
...
insert into codfish_bike_user (user_id, user_name, email, password, active) VALUES(5,'adam_regeneracja','adam.regeneracja@codfishbike.com','$2a$12$FEf.afcwuEPAnRBVcwdtZevcy0dRclVXwT1fl5/0g1gHTJvnhQbO2',true);
...
insert into codfish_bike_user_role (user_id, role_id) VALUES (1,1),(2,1),(3,1),(4,1);
insert into codfish_bike_user_role (user_id, role_id) VALUES (5,2),(6,2),(7,2),(8,2);
